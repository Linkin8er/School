...
def random_list(length, low=0, high=100) :
    ...
    """
    #This makes an array, and then fills it with random numbers from 0 to 100
    #Or whatever the user inputs
    randomArray = []
...
if __name__ == "__main__" :
    ...
    #This section checks to make sure the insertion sort works
    test_List = random_list(10, 0, 100)

    print(test_List)

    isItSorted = is_sorted(test_List)

    if(isItSorted) : print("This list is sorted! Yay!")
    if(not(isItSorted)) : print("This list is not sorted!")
