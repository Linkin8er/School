from DataStructuresAndAlgorithmsWork.graphshw import WeightedGraph
import random
...
# the assignment:
# (a) Your modified graphshw.py which has your implementations of Bellman-Ford and Dijkstra.
...
#
# Do the following:
# 1) Implement bellman_ford inside the WeightedGraph class of
...
#    See comments inside that method for details.
#
# (3) Implement the time_shortest_path_algs function later in this file
#     to do the following:
...
#         you expect Dijkstra's algorithm to be faster (e.g., in terms of graph density)?
#         Be careful, question (a) can be considered a trick question. Also, this question
#         concerns the Big-O runtimes of the algorithms, and not your timing data.
...
#    Bellman Ford or Dijkstra to compute the Single Source Shortest Paths for the source
